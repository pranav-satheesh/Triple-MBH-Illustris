...
fA = RegularGridInterpolator((M1,qin,qout), A, bounds_error=False, fill_value = None)
fB = RegularGridInterpolator((M1,qin,qout), B, bounds_error=False, fill_value = None)
fC = RegularGridInterpolator((M1,qin,qout), C, bounds_error=False, fill_value = None)
fD = RegularGridInterpolator((M1,qin,qout), D, bounds_error=False, fill_value = None)
